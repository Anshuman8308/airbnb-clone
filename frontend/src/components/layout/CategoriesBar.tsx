  ...
  return (
    <>
      <div className="sticky top-20 z-30 bg-white border-b border-gray-100 shadow-xs">
        <div className="mx-auto max-w-[2520px] xl:px-20 md:px-10 sm:px-2 px-4 py-3 flex items-center gap-4">
          {/* Categories Carousel */}
              ...
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 pb-2.5 pt-1 transition cursor-pointer shrink-0 border-b-2 ${
                      isActive
                        ? "border-[#222222] text-[#222222] opacity-100"
                        : "border-transparent text-[#717171] opacity-90 hover:opacity-100 hover:border-gray-200 hover:text-[#222222]"
                    }`}
                  >
